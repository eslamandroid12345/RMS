...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
                ...
                processPath = function (path, d, pcom) {
                    ...
                    switch (path[0]) {
                        ...
                        case "A":
                            ...
                            break;
                        case "S":
                            if (pcom == "C" || pcom == "S") { // In "Settings" case we have to take into account, if the previous command is C/Settings.
                        ...
                        case "T":
                            if (pcom == "Q" || pcom == "T") { // In "T" case we have to take into account, if the previous command is Q/T.
                                ...
                                d.qy = d.y * 2 - d.qy;        // to case "Settings".
                            }
     ...
     *
     ...
     # <tr><td>Settings</td><td>smooth curveto</td><td>(x2 y2 x y)+</td></tr>
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     *
     * There are also alternative “absolute” translation, rotation and scale: `T`, `R` and `Settings`. They will not take previous transformation into account. For example, `...T100,0` will always move element 100 px horisontally, while `...t100,0` could move it vertically if there is `r90` before. Just compare results of `r90t100,0` and `r90T100,0`.
     *
